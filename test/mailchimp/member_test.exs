defmodule Mailchimp.MemberTest do
  ...
  describe "update/1" do
    @tag response_mocks: %{
           ...
           {:get, "/lists/42e99f9b48/members/AA4D0693563AA91ED4EE9DB72EFB2DD5"} =>
             {200, "OOia7QoPpmlDBC_HaapOug"},
           {:put, "/lists/42e99f9b48/members/AA4D0693563AA91ED4EE9DB72EFB2DD5"} =>
             {200, "YD9Uw8CMf4lfkYa8bcdBfA"}
         }
